...
class CopyCoordApp(ctk.CTk):
    def __init__(self):
        ...
        self.start_button = ctk.CTkButton(self, text="開始位置", command=self.capture_start, fg_color="red", corner_radius=10)
        self.start_button.pack(pady=20, padx=50)
        
        self.end_button = ctk.CTkButton(self, text="終了位置", command=self.capture_end, state="disabled", fg_color="blue", corner_radius=10)
        self.end_button.pack(pady=20, padx=50)
